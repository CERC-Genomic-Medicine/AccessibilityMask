...
argparser.add_argument('-dp', '--min-dp', metavar = 'string', dest = 'in_depth', type = str, required = True, help = 'Minimum depth considering as high coverage threshold, must be one of the elements of following list [5, 10, 15, 20, 25, 30, 50, 100].')
